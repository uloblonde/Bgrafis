 ...
 */
public class SimpleJOGL1 implements GLEventListener,MouseListener,MouseMotionListener {
    public static void main(String[] args) {
        Frame frame = new Frame("Konsep 3D");
       ...
       GL gl = drawable.getGL();
        ...
        gl.glEnd();
         ...
         gl.glBegin(GL.GL_POLYGON);
            ...
            gl.glVertex3f(0.2f,1.2f,0.5f);
            gl.glVertex3f(1.0f,1.2f,0.5f);
        gl.glEnd();
        
        gl.glBegin(GL.GL_POLYGON);
            gl.glVertex3f(0.2f,1.2f,0.0f);
            gl.glVertex3f(0.2f,1.8f,0.0f);
            gl.glVertex3f(0.2f,1.8f,0.5f);
            gl.glVertex3f(0.2f,1.2f,0.5f);
        gl.glEnd();
        
        gl.glBegin(GL.GL_POLYGON);
            gl.glVertex3f(0.2f,1.8f,0.0f);
            gl.glVertex3f(1.0f,1.8f,0.0f);
            gl.glVertex3f(1.0f,1.8f,0.5f);
            gl.glVertex3f(0.2f,1.8f,0.5f);
        gl.glEnd();
        ...
        //bawah
         ...
         gl.glBegin(GL.GL_POLYGON);
            gl.glVertex3f(0.0f,0.0f,0.5f);
            gl.glVertex3f(0.1f,0.0f,0.5f);
            gl.glVertex3f(0.1f,0.2f,0.5f);
            gl.glVertex3f(0.0f,2.0f,0.5f);
        gl.glEnd();
        ...
        gl.glBegin(GL.GL_POLYGON);
            ...
            gl.glVertex3f(0.2f,2.0f,0.5f);
            gl.glVertex3f(0.0f,2.0f,0.5f);
        gl.glEnd();
        
        gl.glBegin(GL.GL_POLYGON);
            gl.glVertex3f(0.0f,2.0f,0.5f);
            gl.glVertex3f(0.0f,1.8f,0.5f);
            gl.glVertex3f(1.0f,1.8f,0.5f);
            gl.glVertex3f(1.0f,2.0f,0.5f);
        gl.glEnd();
